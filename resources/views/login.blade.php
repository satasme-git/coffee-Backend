...
<head>
  ...
  <title>Marlen's coffee | Log in</title>
...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="../../index2.html"><b>Marlen's</b>coffee</a>
  </div>
  <!-- /.login-logo -->
  ...
  <p class="login-box-msg">Sign in to start your session</p>
      <!-- <div class="alert alert-success" style="background-color:#69f0ae">
          <p class="msg">Usernam or Password incorrect</p>
      </div> -->
      <center>
      <div style="margin-bottom:20px">
         <img src="{{ asset('images/logo.png')}}" width="80px" alt="User Image">
      ...
      <!-- <div class="alert alert-danger" style="background-color:#69f0ae">
          <p class="msg">Usernam or Password incorrect</p>
      </div> -->
